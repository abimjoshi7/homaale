...
```
cd existing_repo
git remote add origin https://gitlab.com/cagtu/np/cipher/cipher_mobile.git
...
- [ ] [Set up project integrations](https://gitlab.com/cagtu/np/cipher/cipher_mobile/-/settings/integrations)
