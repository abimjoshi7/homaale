...
const kTabBarTitledark = TextStyle(
  fontWeight: FontWeight.w600,
  fontSize: 16,
  color: Color(
    0xffffffff,
...
const kLightBlueText12dark = TextStyle(
  fontWeight: FontWeight.w400,
  fontSize: 12,
  color: Color(0xff3eaeff),
);
...
const kLightBlueText14dark = TextStyle(
  fontWeight: FontWeight.w400,
  fontSize: 14,
  color: Color(0xff3eaeff),
);
...
const kTealText18dark = TextStyle(
  fontWeight: FontWeight.w400,
  fontSize: 18,
  color: kColorTeal,
);
...
const kPurpleText12dark = TextStyle(
  fontWeight: FontWeight.w400,
  fontSize: 12,
  color: kColorDarkPurple,
);
...
const kPurpleText13dark = TextStyle(
  fontWeight: FontWeight.w400,
  fontSize: 13,
  color: kColorDarkPurple,
);
...
const kPurpleText14dark = TextStyle(
  fontWeight: FontWeight.w400,
  fontSize: 14,
...
const kPurpleText16dark = TextStyle(
  fontSize: 16,
  fontWeight: FontWeight.w600,
  color: kColorSecondary,
);
...
const kPurpleText17dark = TextStyle(
  fontSize: 17,
  fontWeight: FontWeight.w600,
  color: kColorSecondary,
);
...
const kPurpleText19dark = TextStyle(
  color: kColorSecondary,
  fontWeight: FontWeight.w600,
  fontSize: 19,
);
...
const kLabelPrimarydark = TextStyle(
  color: kColorSecondary,
  fontWeight: FontWeight.w500,
  fontSize: 18,
);
...
const kLabelPrimary2dak = TextStyle(
  color: kColorSecondary,
  height: 16,
  fontSize: 16,
  fontWeight: FontWeight.w600,
...
const kSkipHelperdark = TextStyle(
  fontSize: 20,
  fontWeight: FontWeight.w400,
  color: Colors.white,
);
...
const kHeading3secondaydark = TextStyle(
  fontWeight: FontWeight.w400,
  fontSize: 14,
  color: Colors.white,
);
...
const kSubHeadingdark = TextStyle(
  fontWeight: FontWeight.w400,
  fontSize: 12,
  color: Colors.white,
);
...
const kRequirementsdark = TextStyle(
  fontWeight: FontWeight.w400,
  fontSize: 12,
  color: kColorSilver,
);
