                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) => InkWell(
                        ...
                        child: SizedBox(
                          ...
                          child: TaskCard(
                            shareLinked: '$kShareLinks/tasks/${state.taskEntityServiceModel.result?[index].id}',
                            ...
                            buttonLabel: state.taskEntityServiceModel.result?[index].createdBy?.id ==
                                ...
                                ? 'View Details'
                                : 'Apply Now',
                            startRate: state.taskEntityServiceModel.result?[index].createdBy?.id ==
                                    context.read<UserBloc>().state.taskerProfile?.user?.id
                                ? '${state.taskEntityServiceModel.result?[index].payableFrom ?? 0}'
                                : '${state.taskEntityServiceModel.result?[index].budgetFrom ?? 0}',
                            endRate: state.taskEntityServiceModel.result?[index].createdBy?.id ==
                                    context.read<UserBloc>().state.taskerProfile?.user?.id
                                ? '${state.taskEntityServiceModel.result?[index].payableTo ?? 0}'
