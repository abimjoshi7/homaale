...
_$_TaskerProfileModel _$$_TaskerProfileModelFromJson(
        Map<String, dynamic> json) =>
    _$_TaskerProfileModel(
      ...
      taskerProfile: (json['taskerProfile'] as List<dynamic>?)
          ?.map((e) => TaskerProfile.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$$_TaskerProfileModelToJson(
        _$_TaskerProfileModel instance) =>
    <String, dynamic>{
      ...
      'taskerProfile': instance.taskerProfile,
    };
