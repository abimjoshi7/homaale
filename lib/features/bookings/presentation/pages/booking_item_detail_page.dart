                          ...
                          if (booking.status == 'Cancelled')
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: BlocBuilder<BookingCancelBloc, BookingCancelState>(builder: (context, state) {
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                            state.bookingCancelModel?.cancellationReason ?? "",
                                            style: Theme.of(context).textTheme.bodySmall,
                                          ),
                                        ],
                                      ),
                                      Row(
                                        children: [
                                          ...
                                          Text(
                                            state.bookingCancelModel?.cancellationDescription ?? "",
                                            style: Theme.of(context).textTheme.bodySmall,
                                          ),
                                        ],
                                      ),
