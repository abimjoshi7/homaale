...
mixin _$Result {
  ...
  num? get progressPercent => throw _privateConstructorUsedError;
...
class _$_Result implements _Result {
  const _$_Result(
      ...
      @JsonKey(name: "booking_merchant") this.bookingMerchant,
      this.city})
      : _images = images,
        _videos = videos,
...
abstract class _Result implements Result {
  const factory _Result(
      ...
      @JsonKey(name: "booking_merchant") final dynamic bookingMerchant,
...
abstract class _ResultCreatedBy implements ResultCreatedBy {
  const factory _ResultCreatedBy(
          ...
          @JsonKey(name: "hourly_rate") final num? hourlyRate}) =
      _$_ResultCreatedBy;
...
abstract class _EntityService implements EntityService {
  const factory _EntityService(
      ...
      @JsonKey(name: "budget_from") final int? budgetFrom,
      ...
      final dynamic merchant,
      final String? event,
      final dynamic avatar}) = _$_EntityService;
...
abstract class _EntityServiceCreatedBy implements EntityServiceCreatedBy {
  const factory _EntityServiceCreatedBy(
      ...
      final String? designation,
      @JsonKey(name: "user_type") final String? userType,
      @JsonKey(name: "is_profile_verified") final String? isProfileVerified,
