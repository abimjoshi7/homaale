...
class BookEntityServiceReq {
  ...
  factory BookEntityServiceReq.fromJson(Map<String, dynamic> json) => BookEntityServiceReq(
        ...
        offer: json["offer"] == null ? [] : List<int>.from(json["offer"].map((x) => x) as Iterable),
        ...
        videos: json["videos"] == null ? [] : List<int>.from(json["videos"].map((x) => x) as Iterable),
      );
