...
class _$_Image implements _Image {
  const _$_Image(
      ...
      this.name,
      this.size,
      @JsonKey(name: 'meida_type') this.mediaType,
      this.media});
...
abstract class _Image implements Image {
  const factory _Image(
      ...
      final String? name,
      final String? size,
      @JsonKey(name: 'meida_type') final String? mediaType,
